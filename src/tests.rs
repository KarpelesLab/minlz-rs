...
fn test_emit_copy() {
    ...
    let test_cases = vec![
        ...
        (
            2048,
            80000,
            vec![0xee, 0x00, 0x08, 0x1d, 0x00, 0x40, 0x38, 0x00],
        ),
        ...
        (
            204800,
            65,
            vec![0xff, 0x00, 0x20, 0x03, 0x00, 0x03, 0x00, 0x20, 0x03, 0x00],
        ),
        (204800, 69, vec![0xff, 0x00, 0x20, 0x03, 0x00, 0x05, 0x00]),
        (
            204800,
            800,
            vec![0xff, 0x00, 0x20, 0x03, 0x00, 0x19, 0x00, 0xdc, 0x01],
        ),
        (
            204800,
            80000,
            vec![0xff, 0x00, 0x20, 0x03, 0x00, 0x1d, 0x00, 0x3c, 0x38, 0x00],
        ),
    ];
...
fn test_decode_edge_cases() {
    ...
    let test_cases = vec![
        ...
        (
            ...
            vec![
                0x0d, 0x0c, b'a', b'b', b'c', b'd', 0x01, 0x01, 0x00, b'z', 0x01, 0x00,
            ],
